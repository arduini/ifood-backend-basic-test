...
public class OpenWeatherMapWeatherServiceTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(weatherService, "url", "http://teste");
    }
    ...
    public void getWeatherSuccess() {
        ...
        ResponseEntity<WeatherVO> responseEntity = new ResponseEntity<WeatherVO>(response, HttpStatus.ACCEPTED);
